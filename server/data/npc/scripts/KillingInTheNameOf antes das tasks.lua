...
selfSay("You gained " .. reward.value[1] .. " experience points.")
...
db.executeQuery("UPDATE `accounts` SET `task_points` = `task_points` + " .. reward.value[1] .. " WHERE `id` = " .. getPlayerAccountId(cid) .. ";")
db.executeQuery("UPDATE `players` SET `task_completed` = `task_completed` + 1 WHERE `name` = '" .. getPlayerName(cid) .. "';")
selfSay("You gained " .. reward.value[1] .. " task points.")
