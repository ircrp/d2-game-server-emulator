...
for i = 1,20 do
  ...
  -- 1 bp
if msgcontains(msg, '2 bp of mf') or msgcontains(msg, '2 bp of mana') or msgcontains(msg, '2 bp of mana fluid') then
	npcHandler:say('Do you want to buy 2 backpack of mana fluid for 2200 gold coins?')
	talk_state = 6
		elseif msgcontains(msg, 'yes') and talk_state == 6 then
			if getPlayerMoney(cid) >= 2200 then
				brown_bp = doPlayerAddItem(cid, 1988, 1)
for i = 1,20 do
				doAddContainerItem(brown_bp, 2006, 7)
end
