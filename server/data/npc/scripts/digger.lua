...
if msgcontains(msg, '10 bp de mf') or msgcontains(msg, '10 bp of mana') or msgcontains(msg, '10 bp of mana fluid') then
	npcHandler:say('Do you want to buy 10 backpacks of mana fluid for 11000 gold coins?')
	talk_state = 6
	
		elseif msgcontains(msg, 'yes') and talk_state == 6 then
			if getPlayerMoney(cid) >= 11000 then
				brown_bp = doPlayerAddItem(cid, 1988, 10)
				doAddContainerItem(brown_bp, 2006, 7)
				doAddContainerItem(brown_bp, 2006, 7)
				doAddContainerItem(brown_bp, 2006, 7)
				doAddContainerItem(brown_bp, 2006, 7)
