...
protected:
    ...
    // BOUNTY
    static int luaDoPlayerHunt(lua_State *L);
    
    static int luaDoPlayerMuteHelp(lua_State *L);
	...
	static int luaDoPlayerAddBless(lua_State *L);
	static int luaDoPlayerRemoveBless(lua_State *L);
    ...
    //CA
	static int32_t luaGetCastsOnline(lua_State* L); // ok
	static int32_t luaDoPlayerSetCastPassword(lua_State* L); // ok
	static int32_t luaDoPlayerSetCastDescription(lua_State* L); // ok
	static int32_t luaDoPlayerSetCastState(lua_State* L); // ok
	static int32_t luaGetPlayerCast(lua_State* L); // ok
	static int32_t luaDoPlayerAddCastBan(lua_State* L); // ok
	static int32_t luaDoPlayerRemoveCastBan(lua_State* L); // ok
	static int32_t luaGetPlayerCastBans(lua_State* L); // ok
	static int32_t luaGetPlayerCastViewers(lua_State* L); // ok
	static int32_t luaDoPlayerAddCastMute(lua_State* L); // ok
	static int32_t luaDoPlayerRemoveCastMute(lua_State* L); // ok
	static int32_t luaGetPlayerCastMutes(lua_State* L); // ok
	...
	static int luaGetPlayerBless(lua_State *L);
	...
	static int luaGetPlayerRunesMade(lua_State *L);
    
    static int luaGetPlayerAccountPkPoints(lua_State *L);
    static int luaDoAddAccountPkPoints(lua_State *L);
	...
	static int luaDoAddAccountBalance(lua_State *L);
	static int luaGetAccountBalance(lua_State *L);
