...
MagicEffectNames magicEffectNames[] = {
    ...
    {"bigplants",         NM_ME_POISON_AREA},
    {"smallplants",       NM_ME_POISON_AREA},
    {"smallearth",        NM_ME_POISON},
    {"stun",              NM_ME_PUFF},
    {"fireattack",        NM_ME_FIRE_AREA},
    {"groundshaker",      NM_ME_PUFF},
    {"stones",            NM_ME_PUFF},
    {"bigclouds",         NM_ME_PUFF},
    {"sleep",             NM_ME_PUFF},
    {"purpleenergy",      NM_ME_ENERGY_DAMAGE },
    {"bubbles",           NM_ME_SOUND_BLUE},
    {"yellowenergy",      NM_ME_YELLOW_RINGS},
...
ShootTypeNames shootTypeNames[] = {
    ...
    {"whirlwindclub",		  NM_SHOOT_DEATH },
    {"smallearth",         NM_SHOOT_LARGEROCK},
    {"earth",          NM_SHOOT_LARGEROCK},
    {"whirlwindsword",         NM_SHOOT_DEATH},
    {"holy",             NM_SHOOT_DEATH},
    {"energyball",         NM_SHOOT_LARGEROCK},
    {"explosion",          NM_SHOOT_FIRE},
    {"infernalbolt",         NM_SHOOT_POWERBOLT},
