...
void mainLoader(const CommandLineOptions& command_opts, ServiceManager* service_manager)
{
	...
	/*const char* p("13023810969787590904350350534691841038405345149534591413338352019638998229064648760997848641398438686085085674726822846670792504260372031829752153145318919");
	const char* q("9052708800461120093305499886545821035861813949798041686118145500950213786058041764246348696044961519067076964611335583013304205545489139946526149866382157");
	const char* d("");*/
	g_RSA.setKey(p, q, d);
    ...
    // BOUNTY
    std::cout << ":: Loading Bounty Hunter info... " << std::flush;
    IOPlayer::instance()->loadBounty();
    std::cout << "[done]" << std::endl;
